...
const Navbar = () => {
  ...
  return (
    <div className={`w-full flex max-[530]:text-[0.6rem] max-sm:px-2 justify-between items-center h-[8vh] fixed top-0 shadow-lg text-white max-md:px-2  shadow-[833ab4]/50 bg-[#49456117] backdrop-blur-md z-50 px-10 transition-all duration-500`}>
