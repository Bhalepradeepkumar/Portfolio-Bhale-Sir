...
const Office = () => {
  return (
    <div className="office mt-10 w-[100vw] min-h-[60vh] border-t-1 border-b-1 flex justify-center text-white items-center">
      <div className="w-[50vw] min-h-[60vh] p-5 flex justify-center items-center">
        <Timeline />
      </div>
      <div className="p-5 min-h-[60vh] w-[50vw] font-sans">
        <p className="mt-[5vh] text-5xl">
